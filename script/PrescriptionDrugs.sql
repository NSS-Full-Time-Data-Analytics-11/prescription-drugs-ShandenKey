--1. 
  --  a. Which prescriber had the highest total number of claims (totaled over all drugs)? Report the npi 
...
--5. 
  ...
  --  b. Which cbsa has the largest combined population? Which has the smallest? Report the CBSA name and 
  --total population.
...
--6. 
  ...
  --  b. For each instance that you found in part a, add a column that indicates whether the drug is an 
  --opioid.
